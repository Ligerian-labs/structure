...
| `@structure-ai/dotenv` | Load `.env` files for local development (cascade, expansion, environment-wins precedence) into config, check required keys, edit files losslessly, `dotenv` CLI group. |
